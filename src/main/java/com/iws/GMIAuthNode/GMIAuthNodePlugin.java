 ...
 * @since AM 5.5.0
 */
public class GMIAuthNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(GMIAuthNodePlugin.currentVersion, 
				Collections.singletonList(GMIAuthNode.class));
	}
	...
	public String getPluginVersion() {
		return GMIAuthNodePlugin.currentVersion;
	}
}
